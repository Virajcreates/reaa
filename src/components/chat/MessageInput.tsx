      ...
      <div className="flex items-end gap-2">
        ...
        {onLanguageChange && (
          <select
            ...
            disabled={disabled}
            className="px-3 py-2 rounded-xl border border-white/[0.1] bg-white/[0.05] text-sm font-medium text-gray-300 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500/50 transition-all cursor-pointer hover:border-white/[0.2] disabled:opacity-50 disabled:cursor-not-allowed backdrop-blur-sm"
